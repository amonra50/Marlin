...
#define STRING_CONFIG_H_AUTHOR "(Dan Scott - SOVOL SV01 - SKR 1.4 Turbo - MARLIN 2.0.x)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  21.3
    #define DEFAULT_Ki  1.79
    #define DEFAULT_Kd  63.6
  #endif
#endif // PIDTEMP
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38.5, 11, -1.575 }
